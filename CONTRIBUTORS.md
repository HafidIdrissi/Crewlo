...
Crewlo is maintained by [Hafid Idrissi](https://github.com/HafidIdrissi). New contributions to
Crewlo are welcome through [issues](https://github.com/HafidIdrissi/Crewlo/issues) and
[pull requests](CONTRIBUTING.md).

## Upstream acknowledgments

The list below credits contributors to Munder Difflin, the project Crewlo builds on. It is a
historical upstream record, **not** a list of Crewlo contributors or Crewlo pull requests.

This upstream record was generated from pull requests rather than commit metadata, so contributors
whose git email did not match their GitHub account were not dropped. It is preserved as an archive;
new Crewlo contributors should be credited separately.

**52 people** contributed to the recorded upstream work.
...
**Want to contribute to Crewlo?** See [open issues](https://github.com/HafidIdrissi/Crewlo/issues)
and the [contribution guide](CONTRIBUTING.md). Bug reports and documentation help count too.

<sub>Historical upstream snapshot generated by `scripts/generate-contributors.mjs`; Crewlo does
not run that upstream generator automatically.</sub>
